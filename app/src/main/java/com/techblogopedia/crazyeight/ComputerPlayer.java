...
public class ComputerPlayer {
    ...
    public int chooseSuit(List<Card> hand){
        ...
        if(numClubs > numDaimonds && numClubs > numHearts && numClubs > numSpades){
            suit=200;
        } else if(numHearts > numDaimonds && numHearts > numClubs && numHearts > numSpades){
            suit=300;
        } else if(numSpades > numDaimonds && numSpades > numClubs && numSpades > numHearts){
            suit = 400;
        }
        return suit;
    }
